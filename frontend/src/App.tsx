...
//     function filterProduse(produse: Produs[]) {
//         const filteredProduse: Produs[] = [];

//         for (const produs of produse) {
//             let matches = 0;

//             if (numeFilter != "") {
//                 if (produs.getNume().includes(numeFilter)) {
//                     matches++;
//                 }
//             } else {
//                 matches++;
...
//             if (
//                 priceRange[MIN_PRICE_INDEX] <= produs.getPret() &&
